...
namespace LibraryServices
{
    public class CheckoutService : ICheckout
    {
        ...
        #region MarkFound method with 2 other method
        ...
        {
            var earliesHold = currentHolds
                .OrderBy(holds => holds.HoldPlaced)
                .FirstOrDefault();

            var card = earliesHold.LibraryCard;

            _context.Remove(earliesHold);
            _context.SaveChanges();
        ...
        public string GetCurrentCheckoutParon(int assetId)
        {
